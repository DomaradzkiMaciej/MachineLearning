...
if args.variant == 'vanilla':
    ...
    raise ValueError(f'Incorrect variant: {args.variant}')
...
if args.function == 'pretrain':
    ...
    conf = trainer.TrainerConfig(max_epochs=650,
                                 batch_size=128,
                                 learning_rate=6e-3,
                                 lr_decay=True,
                                 warmup_tokens=512 * 20,
    ...
    trainer = trainer.Trainer(gpt_model, pretrain_dataset, None, conf)
    trainer.train()
