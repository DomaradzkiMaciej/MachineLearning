...
GLuint bezpbi, bezpbbp,
       ...
       txcbi, txcbp;
GLint  bezpbsize, bezpbofs[12], cpbofs[1], cpibofs[1], txcofs[1];
                      ...
                      const GLfloat *colour )
{
  ...
  if ( bp ) {
    ...
    glBufferSubData ( GL_UNIFORM_BUFFER, bezpbofs[10], sizeof(GLint), &tl );
    glBufferSubData ( GL_UNIFORM_BUFFER, bezpbofs[11], sizeof(GLint), &one );
...
void SetBezierPatchOptions ( BezierPatchObjf *bp, GLint normals, GLint tesslevel )
{
  glBindBuffer ( GL_UNIFORM_BUFFER, bp->buf[0] );
  glBufferSubData ( GL_UNIFORM_BUFFER, bezpbofs[10], sizeof(GLint), &tesslevel );
  glBufferSubData ( GL_UNIFORM_BUFFER, bezpbofs[11], sizeof(GLint), &normals );
